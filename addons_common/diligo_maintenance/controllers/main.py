...
class SupportController(http.Controller):
    ...
    def support_help(self, **kwargs):
        ...
        return http.request.render('diligo_maintenance.support_help_submit_ticket',
                                   {'categories': ticket_categories, 'person_name': person_name, 'email': person_email,
                                    'phone': person_phone, 'department': '',
    ...
    def support_process_ticket(self, **kwargs):
        ...
        create_dict = {'person_name': values['person_name'], 'phone': values['phone'],
                       'department': values['department'], 'category_id': int(values['category']),
                       'email': values['email'],
    ...
    def support_ticket_survey(self, portal_key):
        ...
        if support_ticket.support_rating:
            ...
            return http.request.render('diligo_maintenance.support_ticket_survey_page',
